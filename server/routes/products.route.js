...
router.get('/:id', userMiddleware, productController.getProductById);
router.get('/bycategory/:category', userMiddleware, productController.getProductsByCategory);
...
router.patch('/:id', roleMiddleware(['ADMIN']), productController.updateProduct);
